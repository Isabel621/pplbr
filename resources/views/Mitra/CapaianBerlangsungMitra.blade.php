...
<head>
    ...
    <title>Capaian Berlangsung Mitra</title>
    <link rel="stylesheet" href="../CSS/CapaianBerlangsungMitra.css">
...
<body>
    ...
    <div class="menu">
        <div class="judulmenu">
            ...
            <div>
                <a href="../HTML/CapaianMitra.html">
                    <button class="konfirm">
                        Menunggu Konfirmasi
                    </button>
                </a>
                <a href="../HTML/CapaianBerlangsungMitra.html">
                    <button class="konfirm">
                        Sedang Berlangsung
                    </button>
                </a>
                <a href="../HTML/CapaianSelesaiMitra.html">
                    <button class="konfirm">
                        Selesai
                    </button>
                </a>
