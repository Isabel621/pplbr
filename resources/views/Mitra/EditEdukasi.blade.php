...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/Mitra/EditEdukasi.css')}}">
...
<body>
    ...
    <div class="box">
        ...
        <form action="{{ url('/update-edukasi-mitra'.$edukasi->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            
            <div class="form">
                <label for="">Judul</label><br>
                <input type="text" name="judul" value="{{ $edukasi->judul}}" class="form-control">
                ...
                <p class="image_upload">
                    ...
                    <input type="file" name="gambar" id="userImage" value="{{ $edukasi->gambar}}" class="form-control">
                </p>

                <label for="">Deskripsi</label><br>
                <textarea name="deskripsi" id="desk" rows="10" class="form-control">{{ $edukasi->deskripsi}}</textarea>
